                    ...
                    <div class="flex my-6 flex-col items-stretch w-full space-y-4 md:space-x-4 text-black dark:text-white md:space-y-0 md:flex-row">
                            ...
                            <div class="flex justify-between w-full h-full px-4 pb-9 pt-28 space-x-4" style="background: linear-gradient(337deg, #1f293882, #ffffff00);">
                                <div class="flex flex-col justify-start ">
                                    <div class="flex flex-row items-center">
                                        <img src="https://openweathermap.org/img/wn/{{$weather['weather'][0]['icon']}}.png" alt="" srcset="
                                ...
                                <div class="flex flex-col justify-end flex-wrap border-gray-200 mt-6 md:mt-0 font-font-semibold text-xl ttx">
                                    <span class="text-xs ttx opacity-50">
                                        feels like: <span class="ttx opacity-100 text-lg font-semibold">{{ $weather['main']['feels_like'] }}</span>
                                    </span>
                                    <span class="text-xl ttx">
                                        {{ $weather['name'] }}, <span class="text-xs ttx opacity-85">{{ Location::get($ip)->countryCode }}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-1/2 shadow-lg relative overflow-hidden bg-cover bg-center">
                            <div class="flex justify-between px-4 py-9 w-full h-full space-x-4 bg-white dark:bg-gray-700 ">
                                ...
                                <div class="flex flex-col justify-end flex-wrap text-black dark:text-white border-gray-200 mt-6 md:mt-0 opacity-75 font-medium text-sl break-all max-w-md">
                                    <span class="opacity-80 font-semibold">type :</span> {{ str_replace('_', ' ', $holiday['type']) }}
                                </div>
                            </div>
                        </div>
                    </div>
